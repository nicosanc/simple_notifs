...
from utcToHuman import time_difference
...
class TestTimeSince(unittest.TestCase):
    ...
    def test_seconds_1(self):
        ...
        self.assertEqual(time_difference(dt), "25s")

    def test_seconds_2(self):
        dt = ar.utcnow()
        dt = dt.shift(seconds = -60)
        self.assertEqual(time_difference(dt), "1mi")
    ...
    def test_minutes_2(self):
        ...
        self.assertEqual(time_difference(dt), "1h")

    def test_hours_1(self):
        """Test time delta in hours"""
        dt = ar.utcnow()
        dt = dt.shift(hours = -5)
        self.assertEqual(time_difference(dt), "5h")

    def test_hours_2(self):
        dt = ar.utcnow()
        dt = dt.shift(hours = -24)
        self.assertEqual(time_difference(dt), "1d")
    ...
    def test_days_2(self):
        dt = ar.utcnow()
        dt = dt.shift(days = -7)
        self.assertEqual(time_difference(dt), "1w")
    ...
    def test_weeks_2(self):
        dt = ar.utcnow()
        dt = dt.shift(days = -29)
        self.assertEqual(time_difference(dt), "4w")

    def test_months_1(self):
        """Test time delta in months"""
        dt = ar.utcnow()
        dt = dt.shift(days = -30)
        self.assertEqual(time_difference(dt), "1m")

    def test_months_2(self):
        dt = ar.utcnow()
        dt = dt.shift(days = -365)
        self.assertEqual(time_difference(dt), "1y")
    ...
    def test_years(self):
        ...
        self.assertEqual(time_difference(dt), "3y")
